...
function ReminderBanner() {
    return (
        <div className="flex items-center justify-center px-2 py-1 sm:px-4 sm:py-2 bg-yellow-100 border-b border-yellow-200">
            <span className="text-[#b27a00] font-bold text-xs sm:text-sm md:text-base text-center leading-tight">
