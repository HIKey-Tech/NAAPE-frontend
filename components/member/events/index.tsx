...
export default function EventsComponent() {
    ...
    const filteredEvents = EVENTS.filter((pub) =>
        ...
        <div className="px-8 py-8">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {filteredEvents.length === 0 ? (
                    ...
                    filteredEvents.map((training, idx) => (
                        <EventCard
                            key={idx}
                            ...
                            // Remove onRegister and registerLabel props if they're not provided by training object or not needed
                            disabled={false}
                        />
                    ))
                )}
