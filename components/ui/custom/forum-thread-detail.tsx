...
const ForumThreadDetail: React.FC<ForumThreadDetailProps> = ({ threadId }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            {/* Thread Content */}
            <motion.div
                className="bg-white rounded-xl border-2 border-gray-100 p-8 mb-6"
            ...
            >
                ...
                {/* Title */}
                <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">{thread.title}</h1>
                ...
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <span className="font-semibold text-gray-900">{thread.author.name}</span>
                ...
                <div className="prose max-w-none">
                    <p className="text-gray-700 text-lg whitespace-pre-wrap">{thread.content}</p>
                </div>
            </motion.div>
            ...
            {!thread.isLocked && user && (
                <div className="bg-white rounded-xl border-2 border-gray-100 p-6 mb-6">
                    ...
                    <textarea
                        ...
                        className="w-full border-2 border-gray-200 rounded-lg p-4 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none mb-4"
                        rows={5}
                    />
                    <button
                        onClick={handleReply}
                        disabled={createReply.isPending || !replyContent.trim()}
                        className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 flex items-center gap-2"
                    >
                        <MdSend />
                        Post Reply
                    </button>
