    ...
    return (
        ...
        >
            <div className="max-w-4xl w-full flex flex-col items-center text-center gap-6 mb-4">
                <motion.h1
                    className="text-3xl md:text-4xl lg:text-6xl font-black tracking-tight leading-tight mb-1 text-slate-900"
                ...
                {subheading && (
                    <motion.p
                        className="text-primary text-lg md:text-xl font-semibold max-w-3xl mx-auto"
            ...
            <div className="w-full flex justify-center">
                <div
                    className="relative rounded-2xl h-72 md:h-96 overflow-hidden w-full max-w-3xl border-2 border-slate-800 bg-white group transition-colors duration-300 focus-within:ring-2 focus-within:ring-primary"
                    ...
                    {showArrows && hasMultipleSlides && (
                        <>
                            <motion.button
                                ...
                                className="absolute left-3 top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-primary hover:text-white rounded-full p-2 border border-primary transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary"
                                onClick={goPrev}
                                tabIndex={0}
                                whileTap={tap}
                            ...
                            >
                                <svg width="22" height="22" viewBox="0 0 22 22" className="stroke-primary group-hover:stroke-white transition-colors duration-200" fill="none">
                                    <path d="M13.5 16L9.5 11L13.5 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                                </svg>
                            </motion.button>
                            <motion.button
                                aria-label="Next slide"
                                className="absolute right-3 top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-primary hover:text-white rounded-full p-2 border border-primary transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary"
                                onClick={goNext}
                                tabIndex={0}
                                whileTap={tap}
                                style={{ visibility: total < 2 ? "hidden" : undefined }}
                                ...
                                <motion.button
                                    ...
                                    className={`w-3 h-3 rounded-full border-2 duration-200 transition-all outline-none
                                        ${idx === current
                                            ...
                                            : "bg-white border-primary hover:bg-primary/10 scale-100"}
                                    `}
