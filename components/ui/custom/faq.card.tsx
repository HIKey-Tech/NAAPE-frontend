        ...
        {faqs.map((faq, idx) => (
          ...
          >
            <AccordionTrigger className="py-4 px-4 flex items-center gap-2 text-left justify-between group-hover:bg-background/50 group-focus:bg-background/60 group-active:bg-background/70 transition">
              <span className="font-bold text-base md:text-lg text-slate-900 flex-1">
                Q{idx + 1}. {faq.question}
              </span>
            </AccordionTrigger>
            <AccordionContent className="px-6 py-3 bg-background border-t border-black/10 text-[15px] text-slate-800 leading-relaxed">
