    ...
    return (
        <section className="w-full max-w-6xl mx-auto pt-32 pb-24 px-6">
            ...
            <div className="flex justify-center mt-12">
                <Link href="/events">
                    <NaapButton className="bg-primary border-2 border-transparent hover:bg-primary/90 text-white font-bold px-8 py-3 rounded-full flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all hover:scale-105 min-w-[280px]">
