    ...
    <nav className="w-full sticky top-0 left-0 z-40 bg-white border-b-2 border-[color:var(--primary)] px-6 xl:px-10 py-3 flex items-center justify-between relative">
      ...
      {mobileOpen && (
        <div
          ...
          aria-modal="true"
          id="mobile-nav"
          className="absolute left-0 top-[100%] w-full z-50 bg-white border-t-2 border-[color:var(--primary)] flex flex-col px-4 py-4 gap-2 md:hidden"
        >
          <div className="mb-2 font-black text-[color:var(--primary)] text-xl text-center uppercase tracking-widest">
            Welcome to NAAPE
            <div className="text-xs mt-0.5 font-semibold tracking-normal text-[#3654B2]/60">
