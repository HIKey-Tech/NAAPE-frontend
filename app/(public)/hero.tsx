...
export default function Hero() {
    return (
        <section className="relative w-full h-full bg-[#F5F7FA]  md:px-0 flex flex-col md:flex-row items-center justify-center min-h-full overflow-hidden">
            ...
            {/* Main Content */}
            <div className="relative z-10 flex p-6 h-full flex-col md:flex-row items-center w-full mx-auto gap-4 md:gap-4">
                ...
                <div className="flex-1 text-center md:text-left h-full flex flex-col items-center md:items-start gap-7 md:gap-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mt-3 md:mt-4 w-full md:w-auto items-center md:items-start">
                        <Link href="/register" className="w-full sm:w-auto">
                            <NaapButton
                                className="bg-[#2852B4] hover:bg-[#2347A0] w-full sm:w-auto text-white text-base font-semibold px-7 py-3 shadow rounded-none"
                        ...
                        <Link href="/about" className="w-full sm:w-auto">
                            <NaapButton
                                // variant="outline"
                                className="border-[#2852B4] border text-[#2852B4] hover:bg-[#eef2fa] text-base font-semibold px-7 py-3 w-full sm:w-auto rounded-none bg-white"
                            >
                                Learn More
                            </NaapButton>
                        </Link>
